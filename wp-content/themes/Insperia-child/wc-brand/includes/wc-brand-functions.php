...
function wc_recount_product_brand_after_stock_change($product_id){
...
add_action( 'woocommerce_product_set_stock_status', 'wc_recount_product_brand_after_stock_change' );

function wc_product_brand_change_term_counts($taxonomies){
	$taxonomies[] = 'product_brand';
	return $taxonomies;
}
add_filter('woocommerce_change_term_counts', 'wc_product_brand_change_term_counts');

function wc_subbrand_thumbnail( $brand ) {
...
/**
 * wc_product_dropdown_brands function
 * @return string
 */
function wc_product_dropdown_brands($args=array()){
	...
	$terms = get_terms( 'product_brand', apply_filters( 'wc_product_dropdown_brands_get_terms_args', $args ) );
 ...
 * @param string $size
 */
function wc_get_product_brand_thumbnail_url($brand_id,$size = 'full'){
...
function wc_list_brands( $args = '' ){
	...
	$output = apply_filters( 'wc_list_brands', $output, $args );
