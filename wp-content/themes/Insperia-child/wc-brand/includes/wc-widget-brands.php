...
class WC_Widget_Brands extends WP_Widget {
	
	/**
	 * Constructor
	 */
	public function __construct(){
		$widget_options = array( 'classname' => 'woocommerce wc_widget_brands', 'description' => __( 'A list or dropdown of product brands.','luxury-wp') );
		$control_options = array();
		parent::__construct('wc_widget_brands',__('DHWOO Product Brands','luxury-wp'), $widget_options, $control_options);
	}
	/**
	 * (non-PHPdoc)
	...
	public function widget( $args, $instance ) {
		...
		if ( $dropdown ) {
			...
			include_once(dirname(__FILE__) . '/wc_product_brand_list_walker.php' );
			...
			wc_list_brands( apply_filters( 'wc_product_brands_widget_args', $list_args ) );
